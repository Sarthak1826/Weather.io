...
const API_KEY = "dd5b2c031c314d19673ccc7dceb35eba"; 
    ...
    if(index === 0) {
        return `<div class="d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <h6 class="my-2">Temperature: ${((weatherItem.main.temp - 273.15).toFixed(2))}°C</h6>
                        <h6 class="my-2">Wind: ${weatherItem.wind.speed} M/S</h6>
                        <h6 class="my-2">Humidity: ${weatherItem.main.humidity}%</h6>
                    </div>
        ...
        return `<div class="col mb-3">
                    <div class="card border-0 bg-secondary text-white">
                        <div class="card-body p-3 text-white text-center">
                            ...
                            <h6 class="my-2">Temp: ${((weatherItem.main.temp - 273.15).toFixed(2))}°C</h6>
                            <h6 class="my-2">Wind: ${weatherItem.wind.speed} M/S</h6>
                            <h6 class="my-2">Humidity: ${weatherItem.main.humidity}%</h6>
                        </div>
                    </div>
